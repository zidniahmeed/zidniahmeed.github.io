...
export default function Modal({activeID, setShowModal}) {
  ...
  return (
      <div className='w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40'>
          <div className="w-11/12  md:max-w-[600px] w-full absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transfrom -translate-x-1/2  -translate-y-1/2 p-5" >
              <div><figure>
              ...
              <button onClick={() => setShowModal(false)} className="w-[1.8rem] h-[1.8rem] bg-[white] absolute top-[1.7rem] right-[1.7rem] text-[25px] flex items-center justify-center rounded-[8px] leading-0 cursor_nointer">
                  &times;
              </button>
          </div>
    </div>
